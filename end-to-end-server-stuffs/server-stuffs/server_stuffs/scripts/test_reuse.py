...
class TestBase(TestCase):
    ...
    def make_user(self, username="TestUser", email="test@jacob.squizzlezig.com", password="TestPass", verified=True):
        # Make user
        new_user = UserModel()
    ...
    def make_blacklisted_email(self, email="test@jacob.squizzlezig.com"):
        # Blacklist email
